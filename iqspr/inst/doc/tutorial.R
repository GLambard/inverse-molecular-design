...
#qsprpred_env$model_training(model=c("linear_Bayes","ranger"),params=list(list(NA),list("num.trees" = 200)),n_boot=100,s_boot = #0.85,r_boot = F,parallelize=T)
...
#  }
#  
#  opt_rf <- BayesianOptimization(rf_cvfold, bounds = list("mtry" = c(10,1000), "ntree" = c(100,500)), init_points = 10, n_iter = 2)
...
## ---- fig.align='center', fig.height=8, fig.width=4, include=TRUE--------
